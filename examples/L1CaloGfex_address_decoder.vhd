...
begin
    if rising_edge(clk_i) then
        ...
        if (write_i = '1') then
            case address_i is
                when X"A0010000" =>
                    int_l1calogfex_control.ctest_reg(31 downto 0) <= data_i(31 downto 0);
                when X"A001000C" =>
                    int_l1calogfex_control.n_bcrd_ctrl.glbl_lnks(8 downto 0) <= data_i(17 downto 9);
                    int_l1calogfex_control.n_bcrd_ctrl.jet_lnks(8 downto 0) <= data_i(8 downto 0);
                    int_l1calogfex_control.n_bcrd_ctrl.twr_lnks(10 downto 0) <= data_i(28 downto 18);
                when X"A0010010" =>
                    int_l1calogfex_control.gbt_ctrl.sync <= data_i(1);
                    int_l1calogfex_control.gbt_ctrl.rst <= data_i(2);
                when X"A0010014" =>
                    int_l1calogfex_control.ecr_ctrl.value(7 downto 0) <= data_i(7 downto 0);
                    int_l1calogfex_control.ecr_ctrl.clear <= data_i(28);
                    int_l1calogfex_control.ecr_ctrl.update <= data_i(29);
                when X"A0010020" =>
                    int_l1calogfex_control.aipb_tx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A0010024" =>
                    int_l1calogfex_control.aipb_tx_data(31 downto 0) <= data_i(31 downto 0);
                when X"A0010028" =>
                    int_l1calogfex_control.bipb_tx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A001002C" =>
                    int_l1calogfex_control.bipb_tx_data(31 downto 0) <= data_i(31 downto 0);
                when X"A0010030" =>
                    int_l1calogfex_control.cipb_tx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A0010034" =>
                    int_l1calogfex_control.cipb_tx_data(31 downto 0) <= data_i(31 downto 0);
                when X"A0010038" =>
                    int_l1calogfex_control.aipb_rx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A001003C" =>
                    int_l1calogfex_control.bipb_rx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A0010040" =>
                    int_l1calogfex_control.cipb_rx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A0010044" =>
                    int_l1calogfex_control.zipb_tx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A0010048" =>
                    int_l1calogfex_control.zipb_tx_data(31 downto 0) <= data_i(31 downto 0);
                when X"A001004C" =>
                    int_l1calogfex_control.zipb_rx_ctrl(31 downto 0) <= data_i(31 downto 0);
                when X"A0010158" =>
                    int_l1calogfex_control.test.init_stat_rw(39 downto 8) <= data_i(31 downto 0);
                when X"A001015C" =>
                    int_l1calogfex_control.test.init_stat_rw(7 downto 0) <= data_i(31 downto 24);
                when others => null;
            end case;
        end if;
    end if;
